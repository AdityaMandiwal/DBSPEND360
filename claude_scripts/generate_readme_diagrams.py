...
def render_architecture(path: Path):
  ...
  draw_box(
    ...
    fill=PALETTE['source_fill'],
    edge=PALETTE['source_edge'],
    title_size=12,
    subtitle_size=9.5,
  )
  draw_box(
    ...
    fill=PALETTE['system_fill'],
    edge=PALETTE['system_edge'],
    title_size=12,
    subtitle_size=9.5,
  )
  ...
  draw_box(
    ...
    fill=PALETTE['task_fill'],
    edge=PALETTE['task_edge'],
    title_size=12,
    subtitle_size=9.5,
  )
  draw_box(
  ...
  draw_box(
    ax,
    audit_x,
    table_y + table_h - support_h,
    audit_w,
    support_h,
    'dbspend360_audit_log',
    'per-task SUCCESS / FAILED',
    fill=PALETTE['support_fill'],
    edge=PALETTE['support_edge'],
    title_size=10,
    subtitle_size=8.5,
  )
  draw_box(
  ...
  draw_box(
    ...
    fill=PALETTE['consumer_fill'],
    edge=PALETTE['consumer_edge'],
    title_size=12,
    subtitle_size=9.5,
  )
  draw_box(
    ...
    fill=PALETTE['llm_fill'],
    edge=PALETTE['llm_edge'],
    title_size=12,
    subtitle_size=9.5,
  )
