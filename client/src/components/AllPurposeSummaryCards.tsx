...
export const AllPurposeSummaryCards = ({
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground mt-1">
                portfolio average {formatCurrency(dailyAverageSpend)}/day
              </p>
            </CardContent>
          </Card>
                    ...
                    >
                      <div className="flex items-center space-x-2 min-w-0">
                        ...
                        <span
                          ...
                          title={
                            hasName ? label : `Unnamed — ${cluster.cluster_id}`
                          }
                        >
                          {label}
                        </span>
                      ...
                      <div className="text-right shrink-0 ml-2">
                        ...
                        {!cluster.workspace_covered && (
                          <div className="text-xs text-amber-600">
                            {cluster.total_cloud_cost == null
                              ? "DBU only · cloud not covered"
                              : "Available cloud cost may be partial"}
                          </div>
                        )}
                      </div>
                    </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="text-right shrink-0 ml-2">
                        ...
                        {!user.workspace_covered && (
                          <div className="text-xs text-amber-600">
                            {user.total_cloud_cost == null
                              ? "DBU only · cloud not covered"
                              : "Available cloud cost may be partial"}
                          </div>
                        )}
      ...
      {metrics &&
        metrics.min_cost_per_cluster_day === 0 &&
