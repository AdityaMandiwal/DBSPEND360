...
import { HIGH_COST_USD } from "@/lib/utils";
      ...
      {totalCount > 0 && (
        <div className="flex items-center justify-between">
          <div className="text-sm text-muted-foreground">
            Showing {rows.length} user{rows.length === 1 ? "" : "s"} of{" "}
            {totalCount} total
